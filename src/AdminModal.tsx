                ...
                <div className="space-y-4">
                  {reports.map(report => (
                    <div key={report.id} className="p-4 bg-parchment rounded-xl border border-parchment-border">
                      ...
                      <div className="grid grid-cols-3 gap-2 mt-3 pt-3 border-t border-parchment-border/30">
                        <div className="text-[10px] text-ink-light">
                          <div className="font-bold uppercase tracking-tighter"><TranslatedText text="Legis. Dev." /></div>
                          <div className="text-xs font-bold text-ink">{report.driftResult?.legislative_compliance_deviation}%</div>
                        </div>
                        <div className="text-[10px] text-ink-light">
                          <div className="font-bold uppercase tracking-tighter"><TranslatedText text="Proc. Adh." /></div>
                          <div className="text-xs font-bold text-ink">{report.driftResult?.procedural_adherence}%</div>
                        </div>
                        <div className="text-[10px] text-ink-light">
                          <div className="font-bold uppercase tracking-tighter"><TranslatedText text="Scope Creep" /></div>
                          <div className="text-xs font-bold text-ink">{report.driftResult?.scope_creep}%</div>
                        </div>
                      </div>
                    </div>
                  ))}
